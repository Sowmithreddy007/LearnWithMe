...
def build_summary_prompt(num, total, paper, label="TODAY"):
    return (
        "Summarize this AI research paper for a complete beginner. "
        "The reader just started learning about AI and has no technical background.\n\n"
        "=== PAPER DETAILS ===\n"
        f"Title: {paper['title']}\n"
        ...
        "=== OUTPUT FORMAT ===\n"
        "Write the summary using exactly these sections in this exact order. "
        "Do not add extra sections. Do not skip sections. Write real content — not instructions.\n\n"
        f"PAPER {num} of {total} — {label}\n"
        f"{paper['title']}\n"
        f"Authors: {paper['authors']}\n"
        f"Category: {paper['category']} | Date: {paper['published']}\n\n"
        "--- IN PLAIN ENGLISH ---\n"
        "Write 4 sentences maximum. Pretend you are texting a smart 16-year-old friend "
        "who has never studied AI. Use zero technical terms. Tell them: what the researchers "
        "built or discovered, what problem it solves, and why an ordinary person should care.\n\n"
        "--- REAL-WORLD ANALOGY ---\n"
        "Write one specific, vivid analogy. Compare this research to something from daily life "
        "— food, sports, school, traffic, shopping, or medicine. "
        "The analogy must explain the core idea of the paper, not just the topic area. "
        "Make it concrete and memorable.\n\n"
        "--- WHAT THE RESEARCHERS DID ---\n\n"
        "THE PROBLEM\n"
        "2-3 sentences. What specific challenge existed before this paper? "
        "Why had nobody solved it? What goes wrong without this research?\n\n"
        "THEIR METHOD\n"
        "3-4 sentences. What technique, model, or system did they build? "
        "Every time you use a technical word, immediately explain it in plain English in parentheses. "
        "Example: 'They fine-tuned (further trained on specific data) a transformer "
        "(a type of AI that processes text in chunks) to...'\n\n"
        "RESULTS\n"
        "2-3 sentences. What did they achieve? Include numbers if the abstract mentions them "
        "and explain what those numbers mean in plain terms. "
        "If no numbers are given, write what qualitative improvements they report.\n\n"
        "REAL-WORLD APPLICATIONS\n"
        "Name 2-3 specific industries or groups of people who benefit. "
        "For each, write one sentence on exactly how their work or life improves.\n\n"
        "--- WHAT TO STUDY NEXT ---\n"
        "Give exactly 3 learning recommendations. Each on its own line:\n"
        f"1. [topic name] — why this topic helps you understand this paper\n"
        f"2. [topic name] — why this topic helps you understand this paper\n"
        f"3. [topic name] — why this topic helps you understand this paper\n\n"
        f"Full paper: {paper['link']}"
    )

def build_weekly_overview_prompt(num_papers, weekly_text):
    return (
        "Write a weekly AI research digest for a complete beginner. "
        "The reader has just started learning AI and has no technical background.\n\n"
        "Write using exactly these sections:\n\n"
        "THIS WEEK IN AI RESEARCH\n\n"
        "BIGGEST THEMES\n"
        "3-4 sentences. What were the main research directions this week? "
        "Be specific — name real topics like 'language model reasoning' or "
        "'medical image analysis', not vague phrases like 'various AI advances'. "
        "Write in plain English.\n\n"
        "PAPER OF THE WEEK\n"
        "Name the single most impressive paper. In 3-4 plain sentences, "
        "explain what it did and why it stands above everything else this week. "
        "Write as if recommending it to a curious friend.\n\n"
        "TREND TO WATCH\n"
        "2-3 sentences. Identify one technique or approach appearing in multiple papers "
        "this week. Explain what it is in plain English and why a beginner should "
        "pay attention to it.\n\n"
        "BY CATEGORY\n"
        "Write one plain English sentence for each area:\n"
        "AI: [what happened in general AI]\n"
        "ML: [what happened in machine learning]\n"
        "NLP: [what happened in language AI]\n"
        "Computer Vision: [what happened in image AI]\n"
        "Robotics: [what happened in robotics]\n\n"
        f"PAPERS THIS WEEK:\n{weekly_text[:5000]}"
    )
