...
def build_summary_prompt(num, total, paper, label="TODAY"):
    return (
        ...
        "research paper. Every section must be fully written — no placeholders, "
        "no skipped sections, no meta-commentary. Output only the final summary.\n\n"
        "PAPER DETAILS:\n"
        f"Title: {paper['title']}\n"
        ...
        "SIMPLE VERSION\n"
        "Write exactly 5 sentences in plain English that a curious 16-year-old can "
        "understand without any AI background. Sentence 1: what the researchers built "
        "or discovered. Sentence 2: what specific problem it solves. Sentence 3: how "
        "it works at the most basic level. Sentence 4: what makes it better than "
        "what existed before. Sentence 5: why an ordinary person should care about this.\n\n"
        "REAL-WORLD ANALOGY\n"
        "Write one specific, vivid analogy comparing this research to something from "
        "daily life. The analogy must explain the actual mechanism of the paper, not "
        "just its topic. For example: if the paper improves how AI remembers context, "
        "compare it to how a student uses sticky notes to remember key facts across "
        "chapters rather than rereading the whole book. Make it concrete and memorable. "
        "Write 2-3 sentences.\n\n"
        "THE PROBLEM\n"
        "Write exactly 3 sentences. Sentence 1: what specific limitation or gap existed "
        "in AI research before this paper. Sentence 2: what goes wrong in real applications "
        "because of this gap — give a concrete example of failure. Sentence 3: why this "
        "problem was hard to solve and why nobody had fixed it before.\n\n"
        "THEIR APPROACH\n"
        "Write exactly 4 sentences describing the technique or system they built. "
        "Every technical term must be immediately followed by a plain English explanation "
        "in parentheses — for example: 'transformer (a type of AI that reads text in "
        "overlapping chunks rather than word by word)'. Sentence 1: the core idea of "
        "their method in one sentence. Sentence 2: how they built or trained it. "
        "Sentence 3: what makes their approach different from what came before. "
        "Sentence 4: one specific clever design choice that makes it work.\n\n"
        "RESULTS AND NUMBERS\n"
        "Write exactly 3 sentences. Sentence 1: the main result — what their system "
        "achieved. Sentence 2: if specific numbers appear in the abstract, include them "
        "and explain what they mean in plain terms, for example '94 percent accuracy "
        "means the system gets the right answer 94 times out of every 100'. If no "
        "numbers are given, describe the qualitative improvement they report. "
        "Sentence 3: how this compares to the previous best approach in the field.\n\n"
        "WHO BENEFITS\n"
        "Name exactly 3 specific groups of real people or industries who benefit. "
        "For each group write one sentence describing exactly how their work or life "
        "improves because of this research. Be concrete — name doctors, not 'healthcare', "
        "name students, not 'education', name factory engineers, not 'industry'.\n\n"
        "WHAT TO LEARN NEXT\n"
        "Give exactly 3 topics the student should study to understand this paper better. "
        "Write each on its own line in this format:\n"
        "1. Topic Name — one sentence on why this topic is directly relevant to understanding this paper\n"
        "2. Topic Name — one sentence on relevance\n"
        "3. Topic Name — one sentence on relevance\n\n"
